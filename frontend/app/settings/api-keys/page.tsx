...
<div className="min-h-screen bg-slate-950 text-white">
      <Navbar />
      <div className="max-w-3xl mx-auto p-8 flex flex-col items-center justify-center min-h-[80vh] text-center">
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-12">
          ...
          <p className="text-slate-400 text-sm mt-4 max-w-md mx-auto">
            API key management with full multi-tenancy support is coming in V2. 
            Each user will have isolated data and secure API keys for their production apps.
          </p>
        </div>
      </div>
    </div>
